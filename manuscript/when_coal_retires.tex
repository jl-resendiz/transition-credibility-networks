...
\textbf{Abstract.} I show that fuel-mix similarity between listed power utilities is a measurable transition-risk factor that prices in equity returns at the firm level. Using plant-level data for 703 listed utilities across 80 countries and 175 first-mover coal-retirement events, a one-standard-deviation increase in fuel-mix similarity to a retiring firm is associated with a $-2.2$ percentage point four-month cumulative abnormal return (CAR) under market-adjusted abnormal returns, and $-1.2$ percentage points under a four-factor (Fama-French three-factor plus sample-constructed utility-industry) model. The pricing effect is robust to event-clustered, two-way (event $\times$ firm) clustered, and Fama-MacBeth Newey-West inference; survives a Romano-Wolf step-down correction; and tolerates parallel-trends violations up to $1.26\times$ the largest pre-period deviation under a Rambachan-Roth (2023) sensitivity bound. Geographic proximity, by contrast, is statistically indistinguishable from zero across inference methods. The pricing effect concentrates in markets where coal retirement remains novel: in the United States, where retirements are routine, the channel is silent. Within the non-US sample the effect is strongest in developed-ex-US markets and survives the leave-one-country-out drop of any single contributor; a within-US split between restructured and rate-of-return-regulated states does not support the regulation hypothesis, leaving market saturation as the most parsimonious explanation for the US null. The pricing effect concentrates in firms with concentrated institutional ownership across both sub-samples: in the highest tercile of US 13F manager Herfindahl, $\hat\gamma_{\mathrm{fuel}} = -6.08$ ($t = -3.27$); in the highest tercile of non-US Refinitiv free-float concentration, $\hat\gamma_{\mathrm{fuel}} = -10.90$ ($t = -5.45$), more than twice the full-panel headline. The technology-propagation channel transmits globally where institutional ownership is concentrated. The fuel-mix network expands the investable universe of measurably transition-risk-priced firms by 412 utilities beyond ESG coverage and is constructed entirely from public plant registries, a key advantage for portfolio formation and risk-management applications.
\end{quotation}
...
The carbon premium is now well documented in global equity returns: \citet{BoltonKacperczyk2023} estimate it across 14{,}400 firms in 77 countries, with magnitudes that rise in stricter policy environments. The channel through which this premium propagates across firms (when a transition shock hits one utility, who else reprices?) remains incompletely measured. Listed power utilities are a clean setting in which to study propagation: their generation portfolios are observable from public plant registries, their retirement events are dated, and the population of firms is finite. Coal plants are retiring in some jurisdictions and expanding in others. Over 80 percent of coal reserves must remain unextracted if Paris targets bind \citep{McGlade2015}, placing trillions of dollars in generating assets at risk \citep{Dietz2016}. The macroeconomic consequences of stranding fossil fuel assets are substantial \citep{MercurePollittVinualesEdwards2018}, and the losses fall disproportionately on investors in advanced economies \citep{SemieniukHoldenMercureSalas2022}. Falling renewable costs and gas prices have jointly accelerated coal plant retirements in electricity markets \citep{FellKaffine2018}. Does geographic distance insulate the expanding jurisdictions from the financial consequences of retirement elsewhere?

The evidence in this paper suggests not, with one important qualifier. When a power utility retires coal capacity, the stock prices of technologically similar peers decline in jurisdictions where coal retirement is still uncommon, while geographic proximity has no robust effect at the firm level. A one-standard-deviation increase in fuel-mix similarity predicts a 2.2 percentage point decline in four-month cumulative abnormal returns. The channel through which retirement shocks propagate is technology, not geography. Crucially, the pricing effect is absent in the United States, where coal retirement is routine. Two split-sample tests narrow the candidate explanations for the US null: a within-US split between restructured retail markets and rate-of-return-regulated states does not support the regulation hypothesis (the channel is at least as strong in regulated states), and a non-US developed-versus-emerging split shows the effect is strongest in developed-ex-US markets, weakening informational-efficiency and ownership-structure explanations. The most parsimonious remaining interpretation is market saturation: where coal retirement is routine, each new event carries little incremental information about technology viability.

A simple aggregation argument organizes the empirical pattern. A listed utility typically operates plants in multiple local electricity markets. When a nearby competitor exits, the utility gains market share in that local market. But these local gains are independent across markets and diversify away in the firm's aggregate stock price, much as idiosyncratic sectoral shocks wash out in a balanced production network \citep{AcemogluCarvalhoOzdaglarTahbazSalehi2012}. Technology exposure operates differently. If coal becomes uneconomic in one jurisdiction, every plant using coal faces the same obsolescence risk, regardless of where it is located. Fuel-mix similarity is a common factor and does not diversify. The technology channel dominates in the data because it is the only one that survives aggregation from the plant level to the stock level. Section~\ref{sec:discussion} returns to this asymmetry, which I label \emph{asymmetric aggregation}.

Fuel-mix similarity is constructed as the $L_1$ similarity of capacity-share vectors from the Global Energy Monitor, adapting \citet{HobergPhillips2016}'s product-space proximity construction from text-based 10-K vocabulary to fuel-type capacity shares. The setup fits the design-based exposure framework of \citet{BorusyakHullJaravel2022}: pre-determined fuel-mix shares serve as exposure, each retirement event serves as the shock, and the cross-sectional regression coefficient identifies the dose-response of abnormal returns to technology exposure. The estimated factor premium survives a multi-method inference battery (Fama-MacBeth with Newey-West HAC, event-clustered pooled OLS, and two-way clustering on event $\times$ firm) and a Romano-Wolf step-down correction; under multi-factor (Fama-French three-factor plus sample-constructed utility-industry) abnormal-return adjustment the coefficient shrinks by 35 percent but remains highly significant ($t = -4.50$). The multi-factor diagnostic answers the natural concern that a new factor candidate may simply re-load on size, value, or industry exposures: roughly two-thirds of the fuel-similarity loading is orthogonal to the four-factor model. Pre-determined shares restricted to pre-2014 plant vintages remain significant; a leave-one-event-out sensitivity confirms that no single event dominates; the \citet{Oster2019} coefficient stability bound indicates that unobservables would need to be 36 times more important than observables to explain away the result; and a placebo-window \citet{RambachanRoth2023} sensitivity analysis shows that the headline tolerates parallel-trends violations up to $1.26\times$ the largest pre-period deviation, satisfying the standard Honest DID convention. Newey-West standard errors are stable across lags 4 through 18. The sample covers 703 listed utilities across 80 countries and 175 first-mover retirement events spanning 35 countries.

An additional finding speaks to the investable universe of transition-risk-priced firms. In the 153-firm subsample where both measures exist, ESG environmental scores are the more precise predictor under pooled OLS; under Fama-MacBeth inference, both ESG and fuel-mix similarity survive a joint test (Wald $\chi^2_2 = 25.9$, $p < 0.001$). ESG coverage, however, is concentrated in large developed-market utilities: only 153 of the 565 firms in the operational regression panel carry an environmental score from LSEG Eikon. Fuel-mix similarity, constructed from public plant registries, extends transition-risk measurement to the remaining 412 firms, a 3.7-fold expansion of the panel of firms in which transition risk can be priced. For portfolio formation and ex-ante risk-management applications, the breadth of coverage delivered by fuel-mix exposure is at least as valuable as the precision delivered by ESG where both are available.

These results speak to a question that arises whenever climate policy is unilateral. If only some countries retire fossil capacity, are the others insulated? The asset pricing evidence says no, in jurisdictions where coal retirement remains uncommon. The market penalises coal-heavy utilities in proportion to their fuel-mix similarity to the retiring firm; the channel is silent in the United States, where retirements are routine. Coal retirements send technology signals whose financial reach extends well beyond the country where the retirement occurs, but the strength of those signals depends on market context. The paper documents this pattern; it does not assess whether the retirements themselves are desirable.

The paper contributes to three strands of asset-pricing work. First and most directly, to the carbon-premium literature. \citet{BoltonKacperczyk2023} establish the premium globally; \citet{PastorStambaughTaylor2022} decompose it into ex-ante and ex-post components; \citet{HsuLiTsou2023} document its within-industry slope on emission intensity. Each treats the premium as a \emph{level} property of the cross-section. The fuel-mix network identifies the propagation kernel underneath: when one carbon-intensive firm exits, technologically similar peers reprice in proportion to fuel-mix similarity. The carbon premium is not just a level shift across firms; it has a network structure that the cross-section can recover. Second, to the literature constructing firm-level transition-risk measures. The two leading approaches extract exposure from corporate text (earnings-call transcripts in \citealp{SautnerVanLentVilkovZhang2023}; mimicking portfolios on environmental news in \citealp{EngleGiglioKellyLeeStroebel2020}) or aggregate emissions intensity into a tradeable factor (the BMG factor of \citealp{GorgenJacobNerlingerRiordanRohlederWilkens2020}; the green-factor framework of \citealp{PastorStambaughTaylor2021}). Both measure \emph{firm-level} exposure. Fuel-mix similarity differs in two respects: it is constructed from public plant registries (without disclosure or text mining) and captures \emph{pairwise} technology proximity rather than a firm-level intensity. The pairwise structure is what makes it a propagation measure rather than a level measure: retirement events transmit to peers in proportion to shared technology, not in proportion to own carbon exposure. Option-implied measures of climate tail risk \citep{IlhanSautnerVilkov2021} are complementary; I return to the comparison in Section~\ref{sec:asset_managers}. Third, to the network-propagation framework of \citet{AcemogluCarvalhoOzdaglarTahbazSalehi2012}, in which idiosyncratic shocks transmit through interconnected sectors. I apply this logic to a setting in which the relevant network is defined by shared generation technology rather than input-output linkages. The contagion-versus-competition decomposition builds on \citet{LangStulz1992} and \citet{JorionZhang2007}.
